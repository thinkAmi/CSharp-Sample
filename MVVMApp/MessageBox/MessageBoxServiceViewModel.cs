...
{
    public class MessageBoxServiceViewModel : Microsoft.TeamFoundation.MVVM.ViewModelBase
    {
        ...
        private void ExecuteShowCommand(object x)
        {
            ...
            {
                MessageBoxService.ShowInformation("Yes");
            }
            else
            {
                MessageBoxService.ShowError("No");
            }
        }
    }
}
